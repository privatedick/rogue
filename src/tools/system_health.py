...
class SystemHealthCheck:
    ...
    async def test_environment(self) -> TestResult:
        ...
        return TestResult(
            ...
            error=f"Missing environment variables: {', '.join(missing_vars)}" if missing_vars else "",
    ...
    async def test_project_structure(self) -> TestResult:
        ...
        return TestResult(
            ...
            error=f"Missing directories: {', '.join(missing_dirs)}" if missing_dirs else "",
    ...
    def get_capabilities(self) -> List[str]:
        ...
        if all(r.passed for r in self.results if r.name in ["Environment Configuration", "Gemini API Access"]):
            capabilities.extend([
        ...
        if all(r.passed for r in self.results if r.name in ["Project Structure", "File System Permissions"]):
            capabilities.extend([
